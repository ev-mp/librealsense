...
_COMPOSITE_OPTION_LAYOUTS = {
    rs.composite_option_id.hkr_minz_control: (
        ...
        # DPP control family, then MinZ's 7 logical fields (post design-review layout - see
        # rs_hkr_minz_control.h), then 1 reserved (always 0) slot. Same 8-int32-slot envelope as
        # before, just 7 used/1 reserved instead of 5 used/3 reserved - format string unchanged.
        '<BBHBBiiiiiiii',
