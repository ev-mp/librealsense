...
// RS2_COMPOSITE_OPTION_HKR_TEMPORAL_FILTER_DPP, in this filter's OWN options container (inherited
// via embedded_filter_base) - NOT directly on d500_depth_sensor. Mirrors
