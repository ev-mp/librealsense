...
namespace rs2
{
    ...
    public:
        ...
        // UI state for the HKR Temporal Filter DPP "structured API" panel (gated on
        // RS2_COMPOSITE_OPTION_HKR_TEMPORAL_FILTER_DPP support - see device-model.cpp). Widget
