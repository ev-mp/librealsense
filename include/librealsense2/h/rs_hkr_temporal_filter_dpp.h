...
*
* Public documentation/cast-target structs for RS2_OPTION_HKR_TEMPORAL_FILTER_DPP (see
...
* RS2_OPTION_HKR_TEMPORAL_FILTER_DPP. Tightly packed, no padding required: every field is
...
* rs2_get_composite_option_range(RS2_OPTION_HKR_TEMPORAL_FILTER_DPP). */
